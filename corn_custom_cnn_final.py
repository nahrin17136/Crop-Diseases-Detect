# -*- coding: utf-8 -*-
"""corn-custom-cnn-final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kJqErVzpr9pu3tF7Aye1mmoJXgn0HKBH
...
train_path = '/kaggle/input/splitted-corps-diseases/Splitted/splitted_Corn/train'
test_path = '/kaggle/input/splitted-corps-diseases/Splitted/splitted_Corn/test'
val_path = '/kaggle/input/splitted-corps-diseases/Splitted/splitted_Corn/val'

targetnames = ['Common_Rust',
 'Gray_Leaf_Spot',
 'Healthy',
 'Leaf_Blight']
num_classes = 4
...
plt.plot(fpr[0], tpr[0],'r',label='Common_Rust: ROC curve of (area = %0.2f)' % roc_auc[0])
plt.plot(fpr[1], tpr[1],'y',label='Gray_Leaf_Spot: ROC curve of (area = %0.2f)' % roc_auc[1])
plt.plot(fpr[2], tpr[2],'b',label='Healthy: ROC curve of (area = %0.2f)' % roc_auc[2])
plt.plot(fpr[3], tpr[3],'g',label='Leaf_Blight: ROC curve of (area = %0.2f)' % roc_auc[3])
plt.plot([0, 1], [0, 1], 'k--')
plt.xlim([-0.1, 1.1])
plt.ylim([-0.1, 1.1])
