# -*- coding: utf-8 -*-
"""wheat-cust-cnn-ff.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vA5hSRKfLoxvM7k9aq8t3YwOrZgxk2eW
...
train_path = '/kaggle/input/splitted-corps-diseases/Splitted/splitted_Wheat/train'
...
plt.plot(fpr[0], tpr[0],'r',label='WBR ROC area = %0.4f)' % roc_auc[0])
plt.plot(fpr[1], tpr[1],'y',label='WH ROC area = %0.4f)' % roc_auc[1])
plt.plot(fpr[2], tpr[2],'b',label='WYR ROCarea = %0.4f)' % roc_auc[2])
plt.plot([0, 1], [0, 1], 'k--')
plt.xlim([-0.1, 1.1])
plt.ylim([-0.1, 1.1])
